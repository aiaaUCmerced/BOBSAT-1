# BOBSAT-1
This will store all the CAD models for bobsat-1 with the versions and what not and also code (flight software, simulations whatever). This is exclusively focusing on the engineering aspect of the project, and ideally has minimal reports and what not.
A majority of the reports should be in the box
